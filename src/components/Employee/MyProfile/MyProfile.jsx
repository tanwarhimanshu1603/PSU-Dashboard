...
import { Box, Avatar, Typography, Chip, TextField, Autocomplete} from '@mui/material';
...
function MyProfile({employee, setEmployee,employeeSnapshot,setEmployeeSnapshot,error,setError,loading, setLoading}) {
                    ...
                    <Item sx={{position: 'relative'}}>
                        ...
                        <Box sx={{position:"relative"}}>
                            ...
                            <Box sx={{m:2}}>
                                ...
                                {employee.primaryTechSkill && employee.primaryTechSkill.map((skill) => (
                            ...
                            <Box sx={{m:2}}>
                                ...
                                </Typography>
                                {
                                    ...
                                    getOptionLabel={(option) => option}
                                /> : <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2,mt: 1 }}>
                                {employee.functionalKnowledge && employee.functionalKnowledge.map((skill) => (
                                    <Chip key={skill} label={skill} color="primary" variant="outlined" />
                                ))}
                            </Box>
                                }
